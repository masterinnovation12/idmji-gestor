    ...
    return (
        <div className={`space-y-6 ${className}`}>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
                <div className="flex bg-muted p-1 rounded-2xl w-full sm:w-auto">
                    <button
                        ...
                        className={`flex-1 sm:flex-none px-6 py-2 rounded-xl font-bold text-sm transition-all ${tipo === 'himno'
                            ? 'bg-[#063b7a] text-white shadow-lg'
                            : 'text-[#063b7a] hover:bg-[#063b7a]/5'
                            }`}
                    >
                ...
                {/* Total Time Badge */}
                <div className="flex flex-wrap items-center gap-x-4 gap-y-2 ml-auto text-[10px] font-black uppercase tracking-wider bg-[#063b7a]/5 dark:bg-muted/30 px-4 py-2 rounded-xl border border-[#063b7a]/10 dark:border-border/50">
                    ...
                    <div className="hidden sm:block w-px h-4 bg-border" />
                    <div className="text-[#063b7a] dark:text-primary flex items-center gap-1">
