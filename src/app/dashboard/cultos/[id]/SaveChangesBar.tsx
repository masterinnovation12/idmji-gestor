...
export default function SaveChangesBar({
    ...
    return (
        <div className="fixed bottom-4 inset-x-3 md:inset-x-auto md:right-6 z-120">
            <div className="glass rounded-2xl border border-white/20 shadow-2xl px-3 py-3 md:px-4 md:py-3 flex items-center gap-3">
