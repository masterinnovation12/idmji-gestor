...
/**
 * HistorialTabs — Pestañas de la sección Historial (Lecturas / Temas Alabanza).
 *
 * Se renderiza DENTRO de cada sub-página, justo debajo de su PageHero, para que
 * el orden sea: encabezado → pestañas → contenido (antes vivían en el layout,
 * por encima del hero).
 */
